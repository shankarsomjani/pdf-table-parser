...
LLM_API_KEY = st.secrets.get("LLM_API_KEY", "your-api-key-here")  # or replace with real key during dev
        ...
        if not LLM_API_KEY or LLM_API_KEY == "GR0D-WnPVqT-6Sxg3c-ACBVmlCR4SpubugygvKvwWMM":
            ...
            with st.spinner("Uploading to LLMWhisperer..."):
                ...
                response = requests.post(
                    ...
                    headers={"Authorization": f"Bearer {GR0D-WnPVqT-6Sxg3c-ACBVmlCR4SpubugygvKvwWMM}"},
                    json={
